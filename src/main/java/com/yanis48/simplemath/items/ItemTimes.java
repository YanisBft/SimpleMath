...
public class ItemTimes extends ItemBase
{

	public ItemTimes(String name) {
		super(name);
	}
	...
	{
		tooltip.add("\u00A7e" + I18n.format("item.generic.operation") + " \u00A77" + I18n.format("tile.multiplication.name"));
		tooltip.add("");
		tooltip.add("\u00A75" + I18n.format("item.generic.when_used"));
		tooltip.add("\u00A79 " + I18n.format("item.times.use"));
	}
